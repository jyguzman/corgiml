...
let check_int e = match e with  
  Ast.Literal Integer (e, l) -> Some (Ast.Integer (e, l))
| _ -> None

let check_float e: Ast.literal option = match e with  
    Ast.Literal Float (e, l) -> Some (Float (e, l))
  | _ -> None
